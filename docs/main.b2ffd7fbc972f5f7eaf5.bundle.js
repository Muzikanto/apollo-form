      ...
      39: function(module, __webpack_exports__, __webpack_require__) {
         ...
         function replaceValues(target, source, value) {
            for (var _i = 0, _Object$keys = Object.keys(source); _i < _Object$keys.length; _i++) {
               ...
               if ('object' != typeof source[key] || lodash_default.a.isDate(value))
                  target[key] = value;
         ...
         function firstError(state) {
            for (var k in state)
               return 'object' != typeof state[k] || lodash_default.a.isDate(state[k])
                  ? state[k]
                  : firstError(state[k]);
         }
            ...
            src_FormManager = (function() {
               ...
               return (
                  Object(createClass.a)(FormManager, [
                     ...
                     {
                        key: 'useState',
                        value: function useState(selector) {
                           var _this = this,
                              dependencies =
                        ...
                        value: function watch(selector, handler) {
                           ...
                           return this.apolloClient.cache.watch({
                              ...
                              callback: function callback(_ref) {
                                 ...
                                 lodash_default.a.isEqual(previous, v) ||
...
//# sourceMappingURL=main.b2ffd7fbc972f5f7eaf5.bundle.js.map

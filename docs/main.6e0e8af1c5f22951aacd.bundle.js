   ...
   [0],
   {
      ...
      39: function(module, __webpack_exports__, __webpack_require__) {
         ...
         var objectSpread2 = __webpack_require__(33),
            ...
            slicedToArray = __webpack_require__(67),
            ...
            for (var _i = 0, _Object$keys = Object.keys(source); _i < _Object$keys.length; _i++) {
               ...
               if ('object' == typeof source[key])
                  if (Array.isArray(source[key]))
                     ...
                     'object' != typeof source[key] || lodash_default.a.isDate(value)
                        ? (target[key] = value)
         ...
         function firstError(state) {
            for (var k in state) return state[k] ? state[k] : firstError(state);
         }
            ...
            src_FormManager = (function() {
               function FormManager(props) {
                  Object(classCallCheck.a)(this, FormManager),
                     ...
                     (this.validateOnMount = void 0),
                     (this.enableReinitialize = void 0),
                     (this.initialState = void 0),
                     (this.initialErrors = void 0),
                     (this.initialTouches = void 0),
                     (this.query = void 0),
               ...
               return (
                  Object(createClass.a)(FormManager, [
                     ...
                     {
                        key: 'renewInitialState',
                        value: function renewInitialState(values) {
            ...
            parameters: {
               storySource: {
                  ...
                  locationsMap: {
                     'components--example': {
                        startLoc: { col: 7, line: 112 },
                        endLoc: { col: 1, line: 290 },
                        startBody: { col: 7, line: 112 },
                        endBody: { col: 1, line: 290 },
                     },
                  },
               },
            },
...
//# sourceMappingURL=main.6e0e8af1c5f22951aacd.bundle.js.map
